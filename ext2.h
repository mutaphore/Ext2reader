...
#define BLOCK_ITEMS (BLOCK_SIZE / 4)
#define EXT2_DIR 0x4
#define EXT2_FILE 0x8

/*
 * Structure of a blocks group descriptor (32 bytes)
 */
typedef struct {
...
Block *readBlocks(ext2_inode *inode, uint32_t *numUsed);
...
extern ext2_group_desc *bgdTable;
extern ext2_inode *rootInode;
